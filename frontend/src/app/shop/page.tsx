        ...
        <div className="pb-6">
          {filteredJackpots.length > 0 ? (
            (() => {
              ...
              const moreJackpots = filteredJackpots.slice(1);
              ...
              return (
                <div className="space-y-6">
                  ...
                  {moreJackpots.length > 0 && (
                    <div className="space-y-3">
                      <p className="text-xs font-semibold uppercase tracking-[0.3em] text-gray-400">More jackpots</p>
                      <div className="max-h-[360px] space-y-3 overflow-y-auto pr-2">
                        {moreJackpots.map((item) => {
                          ...
                          return (
                            <div
                              key={item.id}
                              className="flex flex-col gap-3 rounded-2xl border border-black/10 bg-white p-4 shadow-sm"
                            >
                              <div className="flex items-center justify-between text-xs text-gray-500">
                                <span>TRY PRICE</span>
                                <span className="rounded-full bg-black px-3 py-1 text-xs font-semibold text-white">
                              ...
                              <JackpotPlayButton jackpot={item} disabled={!user} />
                            </div>
                          );
                        })}
                      </div>

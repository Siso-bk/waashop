...
export function MysteryBoxSoundFields({ winUrl, loseUrl }: Props) {
    ...
    <div className="grid gap-4 md:grid-cols-2">
      <div className="space-y-2">
        <label className="block text-sm text-slate-600">
          Mystery box win sound URL
          <input
            name="mysteryBoxWinSoundUrl"
            type="text"
            value={winSoundUrl}
      ...
      <div className="space-y-2">
        <label className="block text-sm text-slate-600">
          Mystery box lose sound URL
          <input
            name="mysteryBoxLoseSoundUrl"
            type="text"
            value={loseSoundUrl}

...
export const env = {
  ...
  MINIS_PER_USD: Number(process.env.MINIS_PER_USD || 100),
  USD_TO_ETB: Number(process.env.USD_TO_ETB || 120),
  JACKPOT_WIN_SOUND_URL: process.env.JACKPOT_WIN_SOUND_URL,
  JACKPOT_LOSE_SOUND_URL: process.env.JACKPOT_LOSE_SOUND_URL,
  MYSTERY_BOX_WIN_SOUND_URL: process.env.MYSTERY_BOX_WIN_SOUND_URL,
  MYSTERY_BOX_LOSE_SOUND_URL: process.env.MYSTERY_BOX_LOSE_SOUND_URL,
